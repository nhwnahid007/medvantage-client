...
const DiscountProduct = () => {
  ...
  return (
    <div>
      ...
      <div className="">
      <Swiper loop={true} slidesPerView={3} spaceBetween={30} pagination={{ clickable: true }} modules={[Pagination]} className="mySwiper">
  {discountedMedicines.map((discount) => (
    <SwiperSlide key={discount._id}>
      <img className="relative rounded-md h-72 w-full" src={discount.image} alt="" />
